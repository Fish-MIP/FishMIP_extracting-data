#Source code from isimip-client library available in GitHub: https://github.com/ISI-MIP/isimip-client
#Examples of how to use the library can be found here: https://github.com/ISI-MIP/isimip-client/tree/master/notebooks
