...
#Common mask
mask_all = input('File path to common mask: ')
mask_DBPM = input('File path to DBPM mask: ')
mask_DBEM = input('File path to DBEM mask: ')
...
area_all = xr.open_dataarray(mask_all)*1e6
#Mask for DBPM model
area_DBPM = xr.open_dataarray(mask_DBPM)*1e6
#Mask for DBEM model
area_DBEM = xr.open_dataarray(mask_DBEM)*1e6
#######################################################################################
